<div align="center" style="background: linear-gradient(90deg, #ff00ff, #00ffff); padding: 25px; border-radius: 20px; margin-bottom: 25px;">
  <img src="/html/images/logo.png" width="120" height="120" valign="middle" style="vertical-align:middle;"/>
  ...
  <div style="margin-top:15px;">
    <a href="https://overclockwebshop.netlify.app">
      <img src="https://img.shields.io/badge/Frontend-Netlify-blueviolet?style=for-the-badge&logo=netlify&labelColor=2b2b2b&color=ff00ff" alt="Frontend"/>
    </a>
    <a href="https://webshop-backend-api.onrender.com">
      <img src="https://img.shields.io/badge/Backend-ASP.NET_Core-purple?style=for-the-badge&logo=dotnet&labelColor=2b2b2b&color=00ffff" alt="Backend"/>
    </a>
    <img src="https://img.shields.io/badge/Database-MySQL-orange?style=for-the-badge&logo=mysql&labelColor=2b2b2b&color=ff00ff" alt="Database"/>
    <img src="https://img.shields.io/badge/Live-%E2%9C%85-green?style=for-the-badge&labelColor=2b2b2b&color=00ffff" alt="Live"/>
  </div>
</div>
🌌 OverClock – Premium Hardware Webshop

Az OverClock egy teljes értékű, felhőben hosztolt hardver webáruház, amely a modern webes technológiák szinergiáját mutatja be:

💻 Egyedi dizájn
🔗 Dinamikus API kommunikáció
🧾 Automatizált PDF számlagenerálás

⚠️ A projekt élesben fut a felhőben, nem csak lokálisan.

🌐 Élő Elérhetőségek

Komponens	Technológia	Link

Frontend	Netlify	overclockwebshop.netlify.app

Backend API	Render	
webshop-backend-api.onrender.com

Adatbázis	
Clever Cloud Managed MySQL	Távoli hozzáféréssel
